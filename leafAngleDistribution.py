...
def get_sitename_from_3dCoordinates(xCoord, yCoord, yOffset, gantry_x, str_date):
    
    xPosition = xCoord/1000 + gantry_x
    yPosition = yCoord/1000 - yOffset
    
    latlon = spatial.scanalyzer_to_latlon(xPosition, yPosition)

    s = betydb.get_sites_by_latlon(latlon, str_date)
